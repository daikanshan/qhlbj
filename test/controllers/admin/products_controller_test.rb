...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { abstract: @admin_product.abstract, category: @admin_product.category, img: @admin_product.img, name: @admin_product.name }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { abstract: @admin_product.abstract, category: @admin_product.category, img: @admin_product.img, name: @admin_product.name }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
